...
public class RenderColor extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        try {
            double soLuong = Double.parseDouble(table.getValueAt(row, columnCheck).toString());
            double mucCanhBao = Double.parseDouble(table.getValueAt(row, columnWarning).toString());
