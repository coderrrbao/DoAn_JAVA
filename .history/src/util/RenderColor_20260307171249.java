...
public class RenderColor extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        try {
            int soLuong = Integer.parseInteger(table.getValueAt(row, columnCheck).toString());
            int mucCanhBao = Integer.parseInteger(table.getValueAt(row, columnWarning).toString());
