...
import com.microsoft.schemas.office.office.DoubleclicknotifyAttribute;
    ...
    public static boolean xuatFileSanPham(File file, ArrayList<SanPham> list) {
        ...
        try (FileInputStream fis = new FileInputStream(file);
            ...
            for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                ...
                kh.setTenDaMua(DoubleclicknotifyAttributeformatter.formatCellValue(row.getCell(4)).trim());
