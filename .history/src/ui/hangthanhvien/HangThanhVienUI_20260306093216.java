...
public class HangThanhVienUI extends JPanel {
    ...
    private HangThanhVienBUS bus = new HangThanhVienBUS();
    ...
    private void addEvents() {
        ...
        btnXuatExcel.addActionListener(e -> ExcelUtil.export(bus.layListHangThanhVien(), "DanhSachHangThanhVien"));
        ...
        btnNhapExcel.addActionListener(e -> {
            ...
            if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                if (!file.getName().toLowerCase().endsWith(".xlsx")) {
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn file Excel (.xlsx)");
                    return;
                }

                List<HangThanhVien> list = ExcelUtil.importFile(file, row -> {
                    String maHang = ExcelUtil.getNullableString(row, 0);
                    String tenHang = ExcelUtil.getNullableString(row, 1);
                    Integer phanTramGiam = ExcelUtil.getIntCell(row, 2);
                    Double dieuKien = ExcelUtil.getDoubleCell(row, 3);
                    return new HangThanhVien(maHang, tenHang, phanTramGiam, dieuKien);
                });
                ...
                try {
                    ...
                    hangThanhVienBUS.importExcel(list); // xử lý DB
                    ...
                    JOptionPane.showMessageDialog(null, "Lỗi import: " + ex.getMessage());
