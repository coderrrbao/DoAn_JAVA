...
public class TonKhoNguyenLieuPanel extends JPanel {
    ...
    public TonKhoNguyenLieuPanel() {
        ...
        RenderColor render1 = new RenderColor(4, 7, new Color(255, 205, 210));
        RenderColor render2 = new RenderColor(4, 7, new Color(255, 205, 210));
        table.getColumnModel().getColumn(4).setCellRenderer(render1);
        table.getColumnModel().getColumn(4).setCellRenderer(render2);
    ...
    private void importFile() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Import thất bại! Có dữ liệu trùng hoặc sai. Đã rollback.", "Lỗi", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                if (conn != null) {
