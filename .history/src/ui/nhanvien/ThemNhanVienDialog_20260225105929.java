...
public class ThemNhanVienDialog extends JDialog {
    ...
    public void initUI() {
        ...
        dateField.setPreferredSize(new Dimension(220 + 100 + 10, 30));
        ...
        dateField.add(Box.createRigidArea(new Dimension(gap, 0)));
        .setPreferredSize(new Dimension(widthInput, height));
