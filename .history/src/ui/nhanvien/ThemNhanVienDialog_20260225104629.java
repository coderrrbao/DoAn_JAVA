...
public class ThemNhanVienDialog extends JDialog {
    ...
    public void initUI() {
        ...
        daddressField.setPreferredSize(new Dimension(widthInput + widthLabel + gap, height));
dateLabel.setPreferredSize(new Dimension(widthLabel, height));

        dateLabel.setMaximumSize(new Dimension(widthLabel, height));

        dateLabel.setMinimumSize(new Dimension(widthLabel, height));

        daddressField.add(dateLabel);
