...
public class NhanVienUI extends JPanel {
    ...
    public NhanVienUI() {
        ...
        tableUI.getColumnModel().getColumn(8).setCellRenderer(new IconButtonRender("/assets/icon/sua.svg"));
        tableUI.getColumnModel().getColumn(8).setCellEditor(new IconButtonEditor("/assets/icon/sua.svg", row -> {
