...
public class ThemNhanVienDialog extends JDialog {
    ...
    public void initUI() {
        ...
        JLabel cbGioiTinhLabel = new JLabel("Giới tính");
        cbGioiTinhLabel.setPreferredSize(new Dimension(110, 30));
        cbGioiTinhLabel.setMinimumSize(new Dimension(110, 30));
        cbGioiTinhLabel.setMaximumSize(new Dimension(110, 30));
        dsGioiTinh.add("Nam");
        dsGioiTinh.add("Nữ");
