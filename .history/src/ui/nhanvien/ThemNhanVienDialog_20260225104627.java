...
date.setPreferredSize(new Dimension(widthLabel, height));

        date.setMaximumSize(new Dimension(widthLabel, height));

        date.setMinimumSize(new Dimension(widthLabel, height));

        daddressField.add(date);
