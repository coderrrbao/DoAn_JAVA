...
public class NhanVienUI extends JPanel {
    ...
    public NhanVienUI() {
        ...
        tableUI.getColumn("").setCellRenderer(new IconButtonRender("src/assets/icon/sua.svg"));
        tableUI.getColumn("").setCellEditor(null);(new IconButtonRender("src/assets/icon/sua.svg"));
