...
public class ThongTinCaNhanPanel extends JPanel {
    private JTextField tfMaNV, tfTenNV, tfGioiTinh, tfNgaySinh, tfNgayVaoLam, tfSDT, tfDiaChi, tfChucVu, tfTaiKhoan, tfTrangThai;
    ...
    private NhanVien dongGoiNhanVien() {
        ...
        return new NhanVien(tfMaNV.getText(), tfTenNV.getText(), tfGioiTinh.getText(), tfNgaySinh.getText(), tfNgayVaoLam.getText(),
                tfSDT.getText(), tfDiaChi.getText(), tfChucVu.getText(), tfTaiKhoan.getText(), tfTrangThai.getText(), nhanVien.getAnh());
    }
