...
BEGIN
    ...
    VALUES
        ('NV01', N'Nguyễn Văn Quản Lý', N'Nam', '1990-01-01', '2025-' '0909123456', N'TP.HCM', N'Cửa hàng trưởng', 'admin', 1),
        ('NV02', N'Trần Thị Thu Ngân', N'Nữ', '2000-05-15', '2025-' '0909123457', N'Bình Dương', N'Thu ngân', 'nhanvien1', 1),
        ('NV03', N'Lê Văn Kho', N'Nam', '1995-08-20', '2025-' '0909123458', N'Đồng Nai', N'Thủ kho', 'nhanvienkho', 1),
        ('NV04', N'Phạm Văn Pha Chế', N'Nam', '1998-02-10', '2025-' '0909222333', N'TP.HCM', N'Pha chế', 'phache01', 1),
        ('NV05', N'Lý Thị Pha Chế 2', N'Nữ', '1999-11-20', '2025-' '0909333444', N'TP.HCM', N'Pha chế', 'phache02', 1),
        ('NV06', N'Ngô Văn Bảo Vệ', N'Nam', '1985-06-30', '2025-' '0909555666', N'Long An', N'Bảo vệ', 'baove01', 1),
        ('NV07', N'Đỗ Thị Kế Toán', N'Nữ', '1992-09-09', '2025-' '0909777888', N'TP.HCM', N'Kế toán', 'ketoan01', 1),
        ('NV08', N'Hoàng Văn Giám Sát', N'Nam', '1991-03-03', '2025-' '0909888999', N'TP.HCM', N'Giám sát', 'giamsat01', 1),
        ('NV09', N'Vũ Thị Marketing', N'Nữ', '1997-07-07', '2025-' '0909000111', N'TP.HCM', N'Marketing', 'marketing01', 1),
        ('NV10', N'Bùi Văn Sale 2', N'Nam', '2001-12-12', '2025-' '0909111222', N'Bình Dương', N'Thu ngân', 'sale02', 1),
        ('NV11', N'Trịnh Thị Sale 3', N'Nữ', '2002-01-20', '2025-' '0909333555', N'TP.HCM', N'Thu ngân', 'sale03', 1),
        ('NV12', N'Phan Văn Kho 2', N'Nam', '1996-04-25', '2025-' '0909666777', N'Đồng Nai', N'Thủ kho', 'kho02', 1)
END;
