...
BEGIN
    ...
    VALUES
        ('NV01', N'Nguyễn Hoài Bảo', N'Nam', '2000-01-01', '2025-', '0901234567', N'Địa chỉ 1', '/assets/img/goku.png', 1),
        ('NV02', N'Phạm Hữu Phú', N'Nam', '2000-02-02', '2025-', '0902345678', N'Địa chỉ 2', NULL, 1),
        ('NV03', N'Lê Huy Hoàng', N'Nam', '1995-05-05', '2025-', '0903456789', N'Địa chỉ 3', NULL, 1)
END;
