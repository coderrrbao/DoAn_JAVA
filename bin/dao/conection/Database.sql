...
BEGIN
    ...
    ('Q01', 'NQ01'), ('Q02', 'NQ01'), ('Q03', 'NQ01'), ('Q04', 'NQ01'), ('Q05', 'NQ01'),
    ('Q03', 'NQ02'), ('Q07', 'NQ02'),
    ('Q04', 'NQ03'), ('Q10', 'NQ03'),
    ('Q12', 'NQ04'),
    ('Q05', 'NQ05'), ('Q11', 'NQ05'),
    ('Q09', 'NQ10'), ('Q01', 'NQ10'), ('Q02', 'NQ10')
END;
...
BEGIN
    ...
    ('SP26', N'Coca Cola', 'DM03', 8000, 15000, 'NCC04', 120, N'Có sẵn', '/assets/img/pepsi.png', 330, 10, 1),
    ('SP27', N'7Up', 'DM03', 8000, 15000, 'NCC01', 80, N'Có sẵn', '/assets/img/pepsi.png', 330, 10, 1),
    ('SP28', N'Sting Dâu', 'DM03', 9000, 18000, 'NCC01', 90, N'Có sẵn', '/assets/img/pepsi.png', 330, 10, 1),
    ('SP29', N'Redbull Thái', 'DM03', 10000, 20000, 'NCC06', 50, N'Có sẵn', '/assets/img/pepsi.png', 250, 10, 1),
    ('SP30', N'Nước Suối Dasani', 'DM03', 4000, 10000, 'NCC04', 150, N'Có sẵn', '/assets/img/pepsi.png', 500, 20, 1),
    ('SP31', N'Soda Schweppes', 'DM03', 9000, 18000, 'NCC04', 40, N'Có sẵn', '/assets/img/pepsi.png', 330, 5, 1),
    ...
    ('SP05', N'Bạc Xỉu', 'DM01', 16000, 32000, 'NCC02', 40, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP06', N'Cà Phê Muối', 'DM01', 18000, 35000, 'NCC02', 35, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP07', N'Americano Đá', 'DM01', 14000, 28000, 'NCC02', 40, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP08', N'Cappuccino Nóng', 'DM01', 20000, 45000, 'NCC02', 30, N'Pha chế', '/assets/img/pepsi.png', 350, 10, 1),
    ('SP09', N'Latte Đá', 'DM01', 22000, 45000, 'NCC02', 30, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP10', N'Espresso', 'DM01', 12000, 25000, 'NCC02', 40, N'Pha chế', '/assets/img/pepsi.png', 50, 10, 1),
    ('SP11', N'Mocha', 'DM01', 25000, 50000, 'NCC02', 25, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),

    -- DM02: Trà Sữa
    ('SP04', N'Trà Sữa Truyền Thống', 'DM02', 18000, 35000, 'NCC08', 60, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP12', N'Trà Sữa Thái Xanh', 'DM02', 18000, 35000, 'NCC08', 55, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP13', N'Trà Sữa Thái Đỏ', 'DM02', 18000, 35000, 'NCC08', 55, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP14', N'Trà Sữa Oolong', 'DM02', 20000, 40000, 'NCC08', 50, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP15', N'Trà Sữa Khoai Môn', 'DM02', 22000, 42000, 'NCC08', 45, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP16', N'Trà Sữa Matcha', 'DM02', 25000, 45000, 'NCC08', 40, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP17', N'Trà Sữa Socola', 'DM02', 25000, 45000, 'NCC08', 40, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP18', N'Sữa Tươi Trân Châu Đường Đen', 'DM02', 25000, 45000, 'NCC03', 60, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),
    ('SP19', N'Hồng Trà Macchiato', 'DM02', 20000, 38000, 'NCC08', 45, N'Pha chế', '/assets/img/pepsi.png', 500, 10, 1),

    -- DM07: Trà Trái Cây
    ('SP20', N'Trà Đào Cam Sả', 'DM07', 20000, 45000, 'NCC05', 50, N'Pha chế', '/assets/img/pepsi.png', 700, 10, 1),
    ('SP21', N'Trà Vải Hoa Hồng', 'DM07', 20000, 45000, 'NCC05', 45, N'Pha chế', '/assets/img/pepsi.png', 700, 10, 1),
    ('SP22', N'Trà Ổi Hồng', 'DM07', 18000, 40000, 'NCC05', 40, N'Pha chế', '/assets/img/pepsi.png', 700, 10, 1),
    ('SP23', N'Trà Tắc Xí Muội', 'DM07', 15000, 30000, 'NCC05', 55, N'Pha chế', '/assets/img/pepsi.png', 700, 10, 1),
    ('SP24', N'Trà Dâu Tây', 'DM07', 22000, 48000, 'NCC05', 35, N'Pha chế', '/assets/img/pepsi.png', 700, 10, 1),
    ('SP25', N'Lục Trà Chanh Mật Ong', 'DM07', 18000, 35000, 'NCC05', 50, N'Pha chế', '/assets/img/pepsi.png', 700, 10, 1),

    -- DM05: Sinh Tố & Nước Ép
    ('SP32', N'Sinh Tố Bơ', 'DM05', 25000, 50000, 'NCC05', 20, N'Pha chế', '/assets/img/pepsi.png', 500, 5, 1),
    ('SP33', N'Sinh Tố Xoài', 'DM05', 20000, 45000, 'NCC05', 25, N'Pha chế', '/assets/img/pepsi.png', 500, 5, 1),
    ('SP34', N'Sinh Tố Dâu', 'DM05', 25000, 50000, 'NCC05', 20, N'Pha chế', '/assets/img/pepsi.png', 500, 5, 1),
    ('SP35', N'Nước Ép Cam', 'DM05', 20000, 40000, 'NCC05', 30, N'Pha chế', '/assets/img/pepsi.png', 350, 10, 1),
    ('SP36', N'Nước Ép Táo', 'DM05', 22000, 45000, 'NCC05', 25, N'Pha chế', '/assets/img/pepsi.png', 350, 10, 1),
    ('SP37', N'Nước Ép Dưa Hấu', 'DM05', 15000, 35000, 'NCC05', 40, N'Pha chế', '/assets/img/pepsi.png', 350, 10, 1),
    ('SP38', N'Nước Ép Cà Rốt', 'DM05', 15000, 35000, 'NCC05', 30, N'Pha chế', '/assets/img/pepsi.png', 350, 10, 1),

    -- DM06: Đá Xay
    ('SP39', N'Matcha Đá Xay', 'DM06', 28000, 55000, 'NCC08', 20, N'Pha chế', '/assets/img/pepsi.png', 500, 5, 1),
    ('SP40', N'Cookie Đá Xay', 'DM06', 28000, 55000, 'NCC08', 20, N'Pha chế', '/assets/img/pepsi.png', 500, 5, 1),
    ('SP41', N'Cà Phê Đá Xay', 'DM06', 28000, 55000, 'NCC02', 20, N'Pha chế', '/assets/img/pepsi.png', 500, 5, 1),

    -- DM04: Đồ Ăn Nhẹ & DM09: Bánh Ngọt
    ('SP42', N'Bánh Mì Que', 'DM04', 8000, 15000, 'NCC10', 50, N'Có sẵn', '/assets/img/pepsi.png', 100, 10, 1),
    ('SP43', N'Khô Gà Lá Chanh', 'DM04', 25000, 50000, 'NCC06', 40, N'Có sẵn', '/assets/img/pepsi.png', 200, 10, 1),
    ('SP44', N'Hạt Hướng Dương', 'DM04', 10000, 25000, 'NCC06', 100, N'Có sẵn', '/assets/img/pepsi.png', 150, 20, 1),
    ('SP45', N'Tiramisu', 'DM09', 25000, 45000, 'NCC11', 15, N'Có sẵn', '/assets/img/pepsi.png', 150, 5, 1),
    ('SP46', N'Mousse Chanh Dây', 'DM09', 25000, 45000, 'NCC11', 15, N'Có sẵn', '/assets/img/pepsi.png', 150, 5, 1),
    ('SP47', N'Bánh Croissant', 'DM09', 15000, 30000, 'NCC11', 20, N'Có sẵn', '/assets/img/pepsi.png', 100, 5, 1),
    ('SP48', N'Bánh Flan', 'DM09', 10000, 20000, 'NCC11', 30, N'Có sẵn', '/assets/img/pepsi.png', 100, 10, 1),

    -- DM08: Sữa Chua
    ('SP49', N'Sữa Chua Trân Châu', 'DM08', 20000, 35000, 'NCC03', 30, N'Pha chế', '/assets/img/pepsi.png', 300, 10, 1),
    ('SP50', N'Sữa Chua Dẻo', 'DM08', 15000, 30000, 'NCC03', 35, N'Có sẵn', '/assets/img/pepsi.png', 100, 10, 1)
END;
...
BEGIN
    ...
    ('CT01', 'SP03', 1), -- Cà phê sữa
    ('CT02', 'SP02', 1), -- Cà phê đen
    ('CT03', 'SP04', 1), -- Trà sữa
    ('CT04', 'SP16', 1), -- Matcha
    ('CT05', 'SP32', 1), -- Sinh tố bơ
    ('CT06', 'SP20', 1), -- Trà đào
    ('CT07', 'SP18', 1), -- Sữa tươi TCĐĐ
    ('CT08', 'SP05', 1), -- Bạc xỉu
    ('CT09', 'SP39', 1), -- Matcha đá xay
    ('CT10', 'SP09', 1)  -- Latte
END;
...
BEGIN
    ...
    INSERT INTO ChiTietCongThuc (MaCTCT,MaCT, MaNL, SoLuong) VALUES 
    ...
    ('CTCT13','CT01', 'NL13', 0.2), -- Đá bi
    ('CTCT14','CT01', 'NL11', 1)     -- Ly
END;
...
BEGIN
    ...
    ('KM04', 50, '2024-09-02', '2024-09-02', 1), -- Lễ 2/9
    ('KM05', 15, '2024-02-14', '2024-02-14', 0), -- Valentine cũ
    ('KM06', 30, '2025-01-01', '2025-01-03', 1), -- Năm mới
    ('KM07', 10, '2024-01-01', '2030-12-31', 1)  -- Khuyến mãi dài hạn
END;
...
BEGIN
    ...
    ('HD003', 'SP18', 'SZ13', 2, 90000), -- 45k * 2
    ('HD003', 'SP42', 'SZ01', 1, 15000), -- Bánh mì que (Giả sử map size ảo)
...
BEGIN
    ...
    ('LOSP03', 'PNSP03', 'SP42', 250, '2024-01-15', '2024-01-14', '2024-01-20', 2000000, 1), -- Bánh mì que date ngắn
...
BEGIN
    ...
    ('LONL01', 'PNNL01', 'NL01', 25, '2024-01-12', '2024-01-01', '2024-06-01', 1), -- Cà phê
    ('LONL02', 'PNNL02', 'NL02', 120, '2024-01-13', '2024-01-01', '2024-07-01', 1), -- Sữa đặc
    ('LONL03', 'PNNL03', 'NL05', 20, '2024-01-20', '2023-12-01', '2024-12-01', 1), -- Matcha
    ('LONL04', 'PNNL03', 'NL06', 250, '2024-01-20', '2024-01-15', '2024-03-15', 1), -- Trân châu
    ('LONL05', 'PNNL04', 'NL07', 15, '2024-02-01', '2024-01-01', '2025-01-01', 1)  -- Syrup
END;
...
BEGIN
    ...
    INSERT INTO PhieuHuyNguyenLieu (MaPH, MaLo, NgayHuy, MaNV, LyDo, TongTien, TrangThai) VALUES
